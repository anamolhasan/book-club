...
const BookDetails = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
       {/* Back Button */}
       <Link to={'/books'} className="inline-flex items-center text-gray-600 hover:text-amber-500 mb-8 transition-colors"><FaArrowLeft className="mr-2"/> Back to Books</Link>
       ...
       <div className="max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12">
         ...
         <div>
          ...
          <div>
             ...
             <p className="text-xl text-gray-600">{currentBook.author}</p>
          </div>

          {/* Price and Genre */}
          <div className="space-y-2">
             <p className="text-2xl font-bold text-amber-500">${currentBook.price?.toFixed(2)} USD</p>
             <p className="text-gray-900">Genre: <span>{currentBook.genre}</span></p>
          ...
          <div className="flex space-x-4 pt-6">
            ...
            <Link to={`/books/edit/${currentBook._id}`} className="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">Edit Book</Link>
          </div>

          {/* Additional Details */}
          {/* {currentBook?.isbn && ( */}
            <div className="pt-6 border-t border border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{currentBook.isbn || 'N/A'}</p>
                </div>
                <div>
