          ...
          <form onSubmit={handleSubmit} className="mt-8 relative max-w-xl">
            <div className="relative">
              <input
                ...
                value={searchInput}
                className="w-full px-6 py-4 pl-12 rounded-full bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-amber-500 pr-32"
              />
              ...
              <button
                type="submit"
                className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-amber-500 text-gray-900 px-6 py-2 rounded-full font-semibold hover:bg-amber-400 transition-colors disabled:opacity-50 disabled:hover:bg-amber-500 disabled:cursor-not-allowed"
              >
                SEARCH
              </button>
            </div>
